      ...
      <div className="row p-5 mt-5 border-top text-muted" style={{lineHeight:"1.8", fontSize:"1.1em"}}>
        ...
        <div className="col-6 p-5">
          <p>
            ...
            up on the latest updates on our <a href="" style={{textDecoration:"none"}}>blog</a> or see what the media is&nbsp; 
            <a href="" style={{textDecoration:"none"}}>saying about us</a> 
            &nbsp;or learn more about our business and product <a href="" style={{textDecoration:"none"}}>philosophies</a>.</p>
        </div>
      </div>
    </div>
  );
